...
messages = {
    "welcome_message": {
        ...
        "text": "✨ Привет! \nНачнём знакомиться с новыми людьми? \n \nЕсли да, то ответь пожалуйста на "
    ...
    "age_input_message": {
        "error_text_age_under_16": "Извини. Но чат-ботом могут пользоваться только лица старше 18 лет.",
    ...
    "ask_status_message": {
        ...
        "button_text_status_3": "💸 Бизнес цели"
    },
    "ask_photo_message": {
    ...
    "photo_and_final_register_message": {
        "image_url": "https://telegra.ph/file/ad7079ce8110af0f35771.png",
        "text": "🗒 Твой профиль создан! Теперь ты можешь начать пользоваться чат-ботом",
    ...
    "profile_deleted_message": {
        "image_url": "https://telegra.ph/file/ad7079ce8110af0f35771.png",
        "text": "Твой профиль удален. \nЖалко, что ты ушёл. Если передумаешь, мы будем рады тебя видеть."
    },
    "main_screen_message": {
        "image_url": "https://telegra.ph/file/ad7079ce8110af0f35771.png",
    ...
    "about_project_message": {
        "image_url": "https://telegra.ph/file/ad7079ce8110af0f35771.png",
        "text": " <b>"КликЧат"<\b> - это телеграмм бот полезных знакомств, разработанный с большой любовью для пользователей. "
                             "\nЗдесь ты можешь найти новых друзей, партнеров или просто пообщаться с интересными людьми. "
                             "\n<b>Преимущества "КликЧат"<\b> включают в себя удобный и понятный интерфейс, возможность общаться по целям. <b>Главное преимущество<\b> проекта - он <b>полностью бесплатный<\b>, так что присоединяйся и наслаждайся общением! "
