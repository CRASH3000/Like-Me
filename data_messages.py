...
messages = {
    ...
    "main_screen_message": {
        ...
        "text": "👻 Приветствую тебя <b>друууг!</b>"
                "\n Готов, завести новые знакомства? Я всегда буду готов помочь тебе в этом. "
                "\n\nПомни ты всегда можешь начать искать себе новых товарищей под конкретную цель"
                "\n И чуть не забыл, если тебе кто-то не ответил взаимностью, то не расстраивайся, тут полно людей, "
                "кто хочет завести новые знакомства ",
